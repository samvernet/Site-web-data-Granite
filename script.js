...
function render(data) {
    ...
    grid.innerHTML = data.map((item, index) => `
        <div class="card" onclick="showFiche(${index})">
            ...
            <p><i class="fas fa-monument"></i> Stèle : ${item['Etat de la stèle'] || 'Non vérifié'}</p>
...
function showFiche(index) {
    ...
    document.getElementById('modalData').innerHTML = `
        ...
        <div class="info-row"><i class="fas fa-location-arrow"></i><div><label>GPS (X, Y)</label><span style="font-family:monospace;">${lat || 'N/A'}, ${lng || 'N/A'}</span></div></div>
    `;
